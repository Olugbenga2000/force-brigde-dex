...
function App({web3,contracts,accounts}) {
  ...
  const [orders, setOrders] = useState({
   ...
   const [gwoken, setbalance] = useState({balance: 0, address: '', depositAddress: undefined})
  ...
  useEffect(() =>{
    const init = async() =>{
      ...
      console.log('layer 2 deposit address is ' + depositAddress.addressString)
      setbalance({balance:nerbalance, address: polyjuiceAddress, depositAddress})
      setOrders(orders)
